...
class User_model extends MY_Model{
    ...
    private function init(){
        ...
        $this->rule_set['update'] = array(
          ...
          'unique' => array(
              array('username','users','username',true),
              array('email','users','email',true)
          )
        );

        $this->rule_set['password'] = array(
            'required' => array(
                array('password'),
                array('repassword')
            ),
            'equals' => array(
                array('password','repassword')
            )
        );
    }
    ...
    public function authenticate($username,$password,$api = false)
    {
